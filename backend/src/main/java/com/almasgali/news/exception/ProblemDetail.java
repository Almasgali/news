...
public class ProblemDetail {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (this == other || (other instanceof ProblemDetail &&
                getType().equals(((ProblemDetail) other).getType()) &&
                ObjectUtils.nullSafeEquals(getTitle(), ((ProblemDetail) other).getTitle()) &&
                this.status == ((ProblemDetail) other).status &&
                ObjectUtils.nullSafeEquals(this.detail, ((ProblemDetail) other).detail) &&
                ObjectUtils.nullSafeEquals(this.instance, ((ProblemDetail) other).instance) &&
                ObjectUtils.nullSafeEquals(this.properties, ((ProblemDetail) other).properties)));
    }
